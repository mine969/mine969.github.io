...
// EHU Academy — my own self-hosted, open curriculum (github.com/mine969/ehu-course).
// Maps a cert's domain to the matching EHU part when one genuinely exists.
// Domains without a real curriculum match are left out on purpose — no forced link.
export const ehuAcademy = {
  name: "EHU Academy",
  url: "https://mine969.github.io/ehu-course/",
}

export const ehuLearningPaths = {
  pentest: { part: "08", label: "Network Pentesting" },
  webapp: { part: "06", label: "Web Pentesting" },
  appsec: { part: "06", label: "Web Pentesting" },
  exploitdev: { part: "13", label: "Vuln Research" },
  "malware-re": { part: "22", label: "Malware Analysis" },
  cloud: { part: "10", label: "Cloud Security" },
  "ot-ics-iot": { part: "19", label: "IoT & Hardware" },
  "ai-security": { part: "21", label: "AI Security" },
}

// Free external training matched by domain. Only well-known platforms with
// a real, confirmed offering for that domain — no filler, no guesses.
export const freeLearningResources = {
  pentest: [
  ...
  "malware-re": [
    { name: "MalwareUnicorn RE Workshops", url: "https://malwareunicorn.org/#/workshops" },
    { name: "CyberDefenders", url: "https://cyberdefenders.org/" },
  ],
  "threat-intel": [
    { name: "Blue Team Labs Online", url: "https://blueteamlabs.online/" },
    { name: "MISP Project Training", url: "https://www.misp-project.org/training/" },
  ],
  cloud: [
  ...
  "ot-ics-iot": [
    { name: "CISA ICS Training", url: "https://www.cisa.gov/resources-tools/programs/ics-training-available-through-cisa" },
  ],
  "ai-security": [
...
// Which "band" each domain belongs to, matching the original project's own
// grouping (Offensive / Defensive / Platform & Build / Specialist).
export const domainBand = {
  pentest: "offensive",
  webapp: "offensive",
  exploitdev: "offensive",
  soc: "defensive",
  "incident-response": "defensive",
  forensics: "defensive",
  "malware-re": "defensive",
  "threat-intel": "defensive",
  cloud: "platform",
  "security-engineering": "platform",
  appsec: "platform",
  "ot-ics-iot": "specialist",
